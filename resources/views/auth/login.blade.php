            ...
            <div class="d-flex flex-center w-lg-50 pt-15 pt-lg-0 px-10">
                ...
                <div class="d-flex flex-center flex-lg-start flex-column">
                    ...
                    <a href="{{ url('/') }}" class="mb-7 text-center">
                        <img alt="Logo" src="{{ asset('assets/img/UC_Logo_white_text.png') }}" class="w-25" />
                    </a>
                    <!--end::Logo-->
                    <!--begin::Title-->
                    {{-- <h2 class="text-white fw-normal m-0">Unique Coaching Management System (UCMS)</h2> --}}
                    <!--end::Title-->
                </div>
                <!--begin::Aside-->
            </div>
                    ...
                    <div class="d-flex flex-center flex-column flex-column-fluid px-lg-10 pb-15 pb-lg-20">
                        ...
                        <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" data-kt-redirect-url="{{ route('dashboard') }}"
                            ...
                            <div class="text-center mb-11">
                                ...
                                <!--end::Title-->
                                <!--begin::Subtitle-->
                                <div class="text-gray-500 fw-semibold fs-6">Login to UCMS Panel</div>
                                <!--end::Subtitle=-->
                            </div>
                            <!--begin::Heading-->
